Feature: [NovaPHP][Commenting] Check PHP file header
  The PHP file header should have mandatory information, with specific format for some of them.

  Scenario: The PHP file has no header
    Given there is a file named "features/test_file.php" with:
      ...
      """
    When I check the sniff "NovaPHP.Commenting.FileComment" of the standard "./src/NovaPHP" on the file "features/test_file.php"
    Then the output should contain:
      """
       2 | ERROR | Missing file doc comment
      """

  Scenario: The PHP file header is missing some tags
    Given there is a file named "features/test_file.php" with:
      """
      <?php
      /**
  ...
  Scenario: The PHP file header has unaligned tags
    Given there is a file named "features/test_file.php" with:
      """
      <?php
      /**
  ...
  Scenario: The PHP file header has no year in copyright tag
    Given there is a file named "features/test_file.php" with:
      """
      <?php
      /**
  ...
  Scenario: The PHP file header has only a contact name for author tag
    Given there is a file named "features/test_file.php" with:
      """
      <?php
      /**
  ...
  Scenario: The PHP file header has only an email address for author tag
    Given there is a file named "features/test_file.php" with:
      """
      <?php
      /**
